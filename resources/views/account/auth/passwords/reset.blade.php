...
<div class="register-box">
    ...
    <div class="register-logo">
        <a href="{{ URL::to('account') }}"><b>APP</b>LICATION</a>
    </div>

    <div class="register-box-body">
        <p class="login-box-msg">Rest your password</p>
        <form role="form" method="POST" action="{{ URL::to('account/password/reset') }}">
            {!! csrf_field() !!}
        ...
        <a href="{{ URL::to('account/login') }}" class="text-center">I already have a membership</a>
    </div><!-- /.form-box -->
</div><!-- /.register-box -->
