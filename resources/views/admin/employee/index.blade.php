...
@section('content')
    <div class="row">
        <div class="col-xs-12">
        <p><a href="{{ action('Admin\EmployeeController@create') }}" class="btn btn-sm btn-warning"><i class="fa fa-plus-circle"></i> 创建系统用户</a></p>
        </div>
    </div>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-th-list"></i> 系统用户管理</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                            ...
                            <div class="col-sm-12">
                                <table class="table table-bordered table-hover dataTable" id="example2" role="grid" aria-describedby="example2_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <td>
                                            <a href="{{ action('Admin\EmployeeController@edit',['id'=>$model->id]) }}" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i> 编辑</a>
                                            <a href="{{ action('Admin\EmployeeController@show',['id'=>$model->id]) }}" class="btn btn-xs btn-info"><i class="fa fa-eye"></i> 查看</a>
                                            <form action="{{ action('Admin\EmployeeController@destroy',['id'=>$model->id]) }}" method="POST" style="display: inline-block">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
